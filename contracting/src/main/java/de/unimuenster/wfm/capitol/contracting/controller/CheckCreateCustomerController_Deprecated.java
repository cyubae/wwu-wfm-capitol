...
@ManagedBean
@ConversationScoped
public class CheckCreateCustomerController_Deprecated implements Serializable {

	private static final long serialVersionUID = 1L;
	private static Logger LOGGER = Logger.getLogger(CheckCreateCustomerController_Deprecated.class.getName());
	...
	private void initializeVariables() throws NullPointerException {
		...
		LOGGER.log(Level.INFO, "Called initializeVariables");
		LOGGER.log(Level.INFO, "One more line before!");
		BusinessProcess bp = this.businessProcess;		
		Object var = bp.getVariable("user_iscompany");
		LOGGER.log(Level.INFO, "var: " + var);
//		//iterating over values only
		LOGGER.log(Level.INFO, "One more line after!");
//		LOGGER.log(Level.INFO, "dataMap size : " +dataMap.size());
...
//		}		
	...
	public CheckCreateCustomerController_Deprecated() {
		try{
